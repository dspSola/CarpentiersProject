...
namespace SonicBloom.Koreo.Demos
{
	...
	public class NotePrefab : MonoBehaviour
	{
		...
		public void Initialize(KoreographyEvent evt, Color color, PositionNotesControl laneCont, LevelDisplay gameCont)
		{
			trackedEvent = evt;
			visuals.color = color;
			_postionNotesControl = laneCont;
		...
		void Update()
		{
			...
			if (transform.position.y <= _postionNotesControl.DespawnY)
			{
		...
		void UpdatePosition()
		{
			...
			Vector3 pos = _postionNotesControl.TargetPosition;
