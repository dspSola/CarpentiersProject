...
-------------------------------------------------------------------------------------------------
1.1.1
- NEW: Compatible with Unity 2019 & Unity 2020

1.1.0
- NEW: Compatible with Unity 2017 & Unity 2018

1.0.9
- UPDATE: Removed the use of the JSONObject library (now using Unity builtin Json parser),
- FIX: Inverted compression quality. Before that, a higher number in compression quality meant a
lower quality gif... Now the higher the number, the higher the quality of the gif.

1.0.8
- FIX: Gif Creator now works with Unity 5.4
...
Gif Creator will work starting with Unity 2018.1.
